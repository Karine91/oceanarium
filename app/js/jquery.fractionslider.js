...
(function($) {
	...
	var FractionSlider = function(element, options){
		...
		vars.maxSlide = slider.children('.slider_block__item').length - 1;
		...
		function init(){
			...
			slider.children('.slider_block__item').each(function(index){
				var slide = $(this);
		...
		function stop(){
			...
			slider.find('.slider_block__item').stop(true, true);
		...
		function slideChangeControler(init){
			...
			temp.currentSlide = slider.children('.slider_block__item:eq('+vars.currentSlide+')').addClass('active-slide');
			
			if(temp.currentSlide.length == 0){
				vars.currentSlide = 0;
				temp.currentSlide = slider.children('.slider_block__item:eq('+vars.currentSlide+')');
			}
			...
			if(vars.lastSlide != null){
				...
				temp.lastSlide = slider.children('.slider_block__item:eq('+vars.lastSlide+')');
			}
		...
		function makeResponsive(){
			...
			var objs = slider.children('.slider_block__item').find('*');
